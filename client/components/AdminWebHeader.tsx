...
type AdminNavId = 'home' | 'villas' | 'bookings' | 'people' | 'more';

const NAV_ITEMS: {
  id: AdminNavId;
  label: string;
  route: 'HomeTab' | 'VillasTab' | 'BookingsTab' | 'UsersTab' | 'MoreTab';
  Icon: typeof LayoutGrid;
}[] = [
  { id: 'home', label: 'Home', route: 'HomeTab', Icon: LayoutGrid },
  { id: 'villas', label: 'Villas', route: 'VillasTab', Icon: Building2 },
  { id: 'bookings', label: 'Bookings', route: 'BookingsTab', Icon: BookUser },
  { id: 'people', label: 'People', route: 'UsersTab', Icon: Users },
  { id: 'more', label: 'More', route: 'MoreTab', Icon: Menu },
];

function routeToNavId(routeName?: string): AdminNavId {
  switch (routeName) {
    case 'VillasTab':
      return 'villas';
    case 'BookingsTab':
...
/** Admin-only web chrome — mirrors Android admin tabs (same pattern as HostWebHeader) */
        ...
        <View style={[styles.inner, isMobileWidth && styles.innerCompact]}>
          ...
          >
            ...
            <View>
              ...
              <Text style={[styles.brandSub, { color: theme.textMuted }]}>ADMIN</Text>
            </View>
          </Pressable>
          ...
          >
            ...
            {!isMobileWidth && <Text style={styles.addBtnText}>Add villa</Text>}
          </Pressable>
        </View>
      </View>
      ...
      >
        {NAV_ITEMS.map(({ id, label, route, Icon }) => {
          ...
          return (
            ...
            >
              <Icon size={isMobileWidth ? 14 : 16} color={active ? G : theme.textMuted} />
              {!isMobileWidth && (
                <Text
                  style={[
                    styles.dockLabel,
