...
/* Staggered header content variants */
    ...
    >
      ...
      <div className="container relative z-10 mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          animate={shouldReduceMotion ? undefined : headerInView ? "visible" : "hidden"}
        >
          <div className="space-y-6">
            {/* "Private Residences" with letter-spacing reveal */}
            <motion.span
              className="block text-[10px] font-bold uppercase tracking-[0.4em] text-primary"
              variants={shouldReduceMotion ? undefined : headerItem}
            >
              <motion.span
                animate={
                  !shouldReduceMotion && headerInView
                    ? { letterSpacing: "0.4em" }
                    : { letterSpacing: "0.1em" }
                }
            ...
            {/* Decorative reveal line under heading */}
            <motion.div
