  ...
  return (
    <div className="space-y-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-border/50">
        ...
        <Button className="rounded-none bg-primary hover:bg-primary/90 h-10 px-8 uppercase tracking-widest text-[10px] font-bold shadow-lg shadow-primary/20">
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input className="rounded-none h-11" defaultValue="Larosa Luxury Suites" />
                </div>
                <div className="space-y-2">
                  <Label className="text-[10px] font-bold uppercase tracking-widest">Primary Contact Email</Label>
                  <Input className="rounded-none h-11" defaultValue="concierge@larosa.com" />
                </div>
              </div>
              <div className="space-y-2">
                <Label className="text-[10px] font-bold uppercase tracking-widest">Physical Address</Label>
                <Textarea className="rounded-none resize-none h-20" defaultValue="128 Elite District, Silk Road, Marina Bay, 90210" />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label className="text-[10px] font-bold uppercase tracking-widest">Check-in Time</Label>
                  <Input className="rounded-none h-11" defaultValue="14:00" />
                </div>
                <div className="space-y-2">
                  <Label className="text-[10px] font-bold uppercase tracking-widest">Check-out Time</Label>
                  <Input className="rounded-none h-11" defaultValue="11:00" />
                </div>
              </div>
            </CardContent>
          </Card>
