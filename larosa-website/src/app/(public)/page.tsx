    ...
    <div className="flex flex-col min-h-screen">
      <section className="relative h-screen min-h-[640px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 w-full">
          ...
          >
            <p className="text-primary uppercase tracking-[0.35em] text-xs mb-6 font-medium">
              Welcome to the extraordinary
            </p>
            <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl text-foreground mb-8 leading-tight">
              A Sanctuary of <br />
              <span className="italic text-primary/90">Quiet Opulence</span>
            </h1>
            <p className="text-foreground/75 text-lg md:text-xl max-w-2xl mx-auto mb-12 font-light">
      ...
      <div className="bg-background px-4 pb-8 -mt-10 md:hidden">
        <BookingWidget />
      </div>

      <div className="h-8 md:h-24 bg-background" />
      ...
      <section className="py-36 bg-card border-t border-border text-center px-4 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <p className="text-muted-foreground text-xl mb-12 font-light">
